...
mixin _$Message {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, content, type, timestamp, isStreaming);

  @override
  String toString() {
    return 'Message(id: $id, content: $content, type: $type, timestamp: $timestamp, isStreaming: $isStreaming)';
  }
}
...
extension MessagePatterns on Message {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String content, MessageType type,
            DateTime timestamp, bool isStreaming)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Message() when $default != null:
        return $default(_that.id, _that.content, _that.type, _that.timestamp,
            _that.isStreaming);
      case _:
        return orElse();
    }
