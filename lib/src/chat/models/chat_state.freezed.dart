...
mixin _$ChatState {
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(messages), isLoading, error);
...
abstract mixin class $ChatStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Message> messages, bool isLoading, String? error});
}
...
extension ChatStatePatterns on ChatState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<Message> messages, bool isLoading, String? error)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ChatState() when $default != null:
        return $default(_that.messages, _that.isLoading, _that.error);
      case _:
        return orElse();
    }
  }
