...
part of 'aifarma_core_service.swagger.dart';
...
final class _$AifarmaCoreService extends AifarmaCoreService {
  _$AifarmaCoreService([ChopperClient? client]) {
    if (client == null) return;
    this.client = client;
  }

  @override
  final Type definitionType = AifarmaCoreService;
...
Returns:
    ...
    return client
        .send<DataResponseAgentMetadataDto, DataResponseAgentMetadataDto>(
          $request,
        );
  }
...
Returns:
    ...
    return client
        .send<DataResponseQueryResponseDto, DataResponseQueryResponseDto>(
          $request,
        );
  }
...
Returns:
    ...
    final Uri $url = Uri.parse(
      '/contextual-rag/v1/datastores/${datastoreId}/metadata',
    );
    final Request $request = Request(
      'GET',
      $url,
...
Returns:
    ...
    final Uri $url = Uri.parse(
      '/contextual-rag/v1/datastores/${datastoreId}/reset',
    );
    final Request $request = Request(
      'PUT',
      $url,
...
Returns:
    ...
    final Uri $url = Uri.parse(
      '/contextual-rag/v1/datastores/${datastoreId}/documents',
    );
...
Returns:
    ...
    return client
        .send<DataResponseDocumentMetadataDto, DataResponseDocumentMetadataDto>(
          $request,
        );
  }
...
Returns:
    ...
    final List<PartValue> $parts = <PartValue>[
      PartValue<BodyParseFileContextualRagV1ParseFilePost>('body', body),
    ];
    final Request $request = Request(
      'POST',
      $url,
...
Returns:
    ...
    final Uri $url = Uri.parse(
      '/contextual-rag/v1/parse/jobs/${jobId}/results',
    );
    final Request $request = Request(
      'GET',
      $url,
...
Returns:
    ...
    return client
        .send<DataResponseBalanceResponseDto, DataResponseBalanceResponseDto>(
          $request,
        );
  }
...
Returns:
    ...
    final Uri $url = Uri.parse(
      '/contextual-rag/v1/billing/balance/auto-top-up/enable',
    );
    final $body = body;
    final Request $request = Request(
      'POST',
...
Returns:
    ...
    final Uri $url = Uri.parse(
      '/contextual-rag/v1/billing/balance/auto-top-up/disable',
    );
    final Request $request = Request(
      'POST',
      $url,
...
Returns:
    ...
    final Uri $url = Uri.parse(
      '/contextual-rag/v1/billing/balance/auto-top-up/status',
    );
    final Request $request = Request(
      'GET',
      $url,
...
Returns:
    ...
    final Uri $url = Uri.parse(
      '/contextual-rag/v1/billing/earliest-usage-date',
    );
    final Request $request = Request(
      'GET',
      $url,
