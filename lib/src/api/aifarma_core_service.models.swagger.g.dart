...
part of 'aifarma_core_service.models.swagger.dart';
...
AgentMetadataDto _$AgentMetadataDtoFromJson(Map<String, dynamic> json) =>
    AgentMetadataDto(
      datastoreIds:
          (json['datastore_ids'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          [],
      name: json['name'] as String,
...
AttributionDto _$AttributionDtoFromJson(Map<String, dynamic> json) =>
    AttributionDto(
      contentIds:
          (json['content_ids'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          [],
...
BalanceResponseDto _$BalanceResponseDtoFromJson(Map<String, dynamic> json) =>
    BalanceResponseDto(balance: json['balance']);
...
BillingMetadataResponseDto _$BillingMetadataResponseDtoFromJson(
  Map<String, dynamic> json,
) => BillingMetadataResponseDto(metadata: json['metadata']);
...
BillingModeHistoryResponseDto _$BillingModeHistoryResponseDtoFromJson(
  Map<String, dynamic> json,
) => BillingModeHistoryResponseDto(history: json['history']);
...
_$BodyIngestDocumentContextualRagV1DatastoresDatastoreIdDocumentsPostToJson(
  BodyIngestDocumentContextualRagV1DatastoresDatastoreIdDocumentsPost instance,
) => <String, dynamic>{
...
ConfigurationParsingDto _$ConfigurationParsingDtoFromJson(
  ...
  enableSplitTables: json['enable_split_tables'] as bool?,
  figureCaptionMode: configurationParsingDtoFigureCaptionModeNullableFromJson(
...
Map<String, dynamic> _$ConfigurationParsingDtoToJson(
  ...
  'enable_split_tables': instance.enableSplitTables,
  'figure_caption_mode': configurationParsingDtoFigureCaptionModeNullableToJson(
...
CreateDatastoreResponseDto _$CreateDatastoreResponseDtoFromJson(
  Map<String, dynamic> json,
) => CreateDatastoreResponseDto(id: json['id'] as String);
...
DataResponseAutoTopUpResponseDto _$DataResponseAutoTopUpResponseDtoFromJson(
  ...
  status: DataResponseAutoTopUpResponseDto.responseStatusStatusNullableFromJson(
    json['status'],
  ),
  message: json['message'] as String?,
  data: json['data'] == null
...
_$DataResponseAutoTopUpStatusResponseDtoFromJson(
  ...
  status:
      DataResponseAutoTopUpStatusResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
...
DataResponseBalanceResponseDto _$DataResponseBalanceResponseDtoFromJson(
  ...
  status: DataResponseBalanceResponseDto.responseStatusStatusNullableFromJson(
    json['status'],
  ),
  message: json['message'] as String?,
  data: json['data'] == null
...
_$DataResponseBillingMetadataResponseDtoFromJson(
  ...
  status:
      DataResponseBillingMetadataResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
...
_$DataResponseBillingModeHistoryResponseDtoFromJson(
  ...
  status:
      DataResponseBillingModeHistoryResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
...
DataResponseCreateAgentOutputDto _$DataResponseCreateAgentOutputDtoFromJson(
  ...
  status: DataResponseCreateAgentOutputDto.responseStatusStatusNullableFromJson(
    json['status'],
  ),
  message: json['message'] as String?,
  data: json['data'] == null
...
_$DataResponseCreateDatastoreResponseDtoFromJson(
  ...
  status:
      DataResponseCreateDatastoreResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
...
DataResponseDatastoreMetadataDto _$DataResponseDatastoreMetadataDtoFromJson(
  ...
  status: DataResponseDatastoreMetadataDto.responseStatusStatusNullableFromJson(
    json['status'],
  ),
  message: json['message'] as String?,
  data: json['data'] == null
...
_$DataResponseDatastoreUpdateResponseDtoFromJson(
  ...
  status:
      DataResponseDatastoreUpdateResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
...
DataResponseDocumentMetadataDto _$DataResponseDocumentMetadataDtoFromJson(
  ...
  status: DataResponseDocumentMetadataDto.responseStatusStatusNullableFromJson(
    json['status'],
  ),
  message: json['message'] as String?,
  data: json['data'] == null
      ? null
      : SrcContextualRagModelsDatastoresDatastoreDocumentDtoDocumentMetadataDto.fromJson(
          json['data'] as Map<String, dynamic>,
        ),
  error: json['error'] as String?,
);
...
_$DataResponseEarliestUsageDateResponseDtoFromJson(
  ...
  status:
      DataResponseEarliestUsageDateResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
...
_$DataResponseGenerateCreateResponseDtoFromJson(
  ...
  status:
      DataResponseGenerateCreateResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
...
DataResponseIngestionResponseDto _$DataResponseIngestionResponseDtoFromJson(
  ...
  status: DataResponseIngestionResponseDto.responseStatusStatusNullableFromJson(
    json['status'],
  ),
  message: json['message'] as String?,
  data: json['data'] == null
...
DataResponseListAgentsResponseDto _$DataResponseListAgentsResponseDtoFromJson(
  ...
  status:
      DataResponseListAgentsResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
      ? null
      : ListAgentsResponseDto.fromJson(json['data'] as Map<String, dynamic>),
  error: json['error'] as String?,
);
...
_$DataResponseListDatastoresResponseDtoFromJson(
  ...
  status:
      DataResponseListDatastoresResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
...
_$DataResponseListDocumentsResponseDtoFromJson(
  Map<String, dynamic> json,
) => DataResponseListDocumentsResponseDto(
  status:
      DataResponseListDocumentsResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
      ? null
      : ListDocumentsResponseDto.fromJson(json['data'] as Map<String, dynamic>),
  error: json['error'] as String?,
);
...
_$DataResponseMonthlyUsageResponseDtoFromJson(
  Map<String, dynamic> json,
) => DataResponseMonthlyUsageResponseDto(
  status:
      DataResponseMonthlyUsageResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
      ? null
      : MonthlyUsageResponseDto.fromJson(json['data'] as Map<String, dynamic>),
  error: json['error'] as String?,
);
...
DataResponseParseCreateResponseDto _$DataResponseParseCreateResponseDtoFromJson(
  ...
  status:
      DataResponseParseCreateResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
      ? null
      : ParseCreateResponseDto.fromJson(json['data'] as Map<String, dynamic>),
  error: json['error'] as String?,
);
...
_$DataResponseParseJobResultsResponseDtoFromJson(
  ...
  status:
      DataResponseParseJobResultsResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
...
_$DataResponseParseJobStatusResponseDtoFromJson(
  ...
  status:
      DataResponseParseJobStatusResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
...
DataResponseParseJobsResponseDto _$DataResponseParseJobsResponseDtoFromJson(
  ...
  status: DataResponseParseJobsResponseDto.responseStatusStatusNullableFromJson(
    json['status'],
  ),
  message: json['message'] as String?,
  data: json['data'] == null
...
DataResponseParseResultResponseDto _$DataResponseParseResultResponseDtoFromJson(
  ...
  status:
      DataResponseParseResultResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
      ? null
      : ParseResultResponseDto.fromJson(json['data'] as Map<String, dynamic>),
  error: json['error'] as String?,
);
...
_$DataResponseQueryMetricsResponseDtoFromJson(
  Map<String, dynamic> json,
) => DataResponseQueryMetricsResponseDto(
  status:
      DataResponseQueryMetricsResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
      ? null
      : QueryMetricsResponseDto.fromJson(json['data'] as Map<String, dynamic>),
  error: json['error'] as String?,
);
...
_$DataResponseRerankCreateResponseDtoFromJson(
  Map<String, dynamic> json,
) => DataResponseRerankCreateResponseDto(
  status:
      DataResponseRerankCreateResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
      ? null
      : RerankCreateResponseDto.fromJson(json['data'] as Map<String, dynamic>),
  error: json['error'] as String?,
);
...
_$DataResponseRetrievalInfoResponseDtoFromJson(
  Map<String, dynamic> json,
) => DataResponseRetrievalInfoResponseDto(
  status:
      DataResponseRetrievalInfoResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
      ? null
      : RetrievalInfoResponseDto.fromJson(json['data'] as Map<String, dynamic>),
  error: json['error'] as String?,
);
...
_$DataResponseTopUpHistoryResponseDtoFromJson(
  Map<String, dynamic> json,
) => DataResponseTopUpHistoryResponseDto(
  status:
      DataResponseTopUpHistoryResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
      ? null
      : TopUpHistoryResponseDto.fromJson(json['data'] as Map<String, dynamic>),
  error: json['error'] as String?,
);
...
DatastoreMetadataDto _$DatastoreMetadataDtoFromJson(
  ...
  agentIds:
      (json['agent_ids'] as List<dynamic>?)?.map((e) => e as String).toList() ??
      [],
  createdAt: DateTime.parse(json['created_at'] as String),
  name: json['name'] as String,
  configuration: json['configuration'] == null
...
DatastoreUpdateResponseDto _$DatastoreUpdateResponseDtoFromJson(
  Map<String, dynamic> json,
) => DatastoreUpdateResponseDto(id: json['id'] as String);
...
DatastoreUsagesDto _$DatastoreUsagesDtoFromJson(Map<String, dynamic> json) =>
    DatastoreUsagesDto(sizeGb: (json['size_gb'] as num).toDouble());

Map<String, dynamic> _$DatastoreUsagesDtoToJson(DatastoreUsagesDto instance) =>
    <String, dynamic>{'size_gb': instance.sizeGb};
...
DocumentMetadataHierarchyBlockDto _$DocumentMetadataHierarchyBlockDtoFromJson(
  ...
  parentIds:
      (json['parent_ids'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      [],
);
...
DocumentMetadataHierarchyDto _$DocumentMetadataHierarchyDtoFromJson(
  ...
  blocks:
      (json['blocks'] as List<dynamic>?)
          ?.map(
            (e) => DocumentMetadataHierarchyBlockDto.fromJson(
...
DocumentsFiltersQuery _$DocumentsFiltersQueryFromJson(
  ...
  filters:
      (json['filters'] as List<dynamic>?)
          ?.map((e) => DocumentFilterQuery.fromJson(e as Map<String, dynamic>))
          .toList() ??
      [],
  $operator:
      DocumentsFiltersQuery.documentsFiltersQueryOperator$operatorNullableFromJson(
        json['operator'],
      ),
);
...
Map<String, dynamic> _$DocumentsFiltersQueryToJson(
  ...
  'operator': documentsFiltersQueryOperatorNullableToJson(instance.$operator),
};

EarliestUsageDateResponseDto _$EarliestUsageDateResponseDtoFromJson(
  Map<String, dynamic> json,
) => EarliestUsageDateResponseDto(date: json['date']);
...
GenerateCreateResponseDto _$GenerateCreateResponseDtoFromJson(
  Map<String, dynamic> json,
) => GenerateCreateResponseDto(response: json['response'] as String);
...
IncrementBalanceRequest _$IncrementBalanceRequestFromJson(
  Map<String, dynamic> json,
) => IncrementBalanceRequest(amount: (json['amount'] as num).toDouble());
...
IngestionResponseDto _$IngestionResponseDtoFromJson(
  Map<String, dynamic> json,
) => IngestionResponseDto(id: json['id'] as String);
...
ListDatastoresResponseDto _$ListDatastoresResponseDtoFromJson(
  ...
  datastores:
      (json['datastores'] as List<dynamic>?)
...
Message _$MessageFromJson(Map<String, dynamic> json) =>
    Message(content: json['content'] as String, role: json['role'] as String);
...
MonthlyUsageResponseDto _$MonthlyUsageResponseDtoFromJson(
  Map<String, dynamic> json,
) => MonthlyUsageResponseDto(usage: json['usage']);
...
PageBlockDto _$PageBlockDtoFromJson(Map<String, dynamic> json) => PageBlockDto(
  ...
  confidenceLevel: pageBlockDtoConfidenceLevelNullableFromJson(
    json['confidence_level'],
  ),
  hierarchyLevel: (json['hierarchy_level'] as num?)?.toInt(),
  pageIndex: (json['page_index'] as num?)?.toInt(),
...
Map<String, dynamic> _$PageBlockDtoToJson(PageBlockDto instance) =>
    <String, dynamic>{
      ...
      'confidence_level': pageBlockDtoConfidenceLevelNullableToJson(
        instance.confidenceLevel,
      ),
      'hierarchy_level': instance.hierarchyLevel,
      'page_index': instance.pageIndex,
...
ParseCreateResponseDto _$ParseCreateResponseDtoFromJson(
  Map<String, dynamic> json,
) => ParseCreateResponseDto(jobId: json['job_id'] as String);
...
ParseJobResultsResponseDto _$ParseJobResultsResponseDtoFromJson(
  ...
  documentMetadata: json['document_metadata'] == null
      ? null
      : SrcContextualRagModelsComponentsParseDtoDocumentMetadataDto.fromJson(
...
ParseResultResponseDto _$ParseResultResponseDtoFromJson(
  Map<String, dynamic> json,
) => ParseResultResponseDto(result: json['result']);
...
QueryResponseDto _$QueryResponseDtoFromJson(
  Map<String, dynamic> json,
) => QueryResponseDto(
  conversationId: json['conversation_id'] as String,
  retrievalContents:
      (json['retrieval_contents'] as List<dynamic>?)
          ?.map((e) => RetrievalContentDto.fromJson(e as Map<String, dynamic>))
          .toList() ??
      [],
  attributions:
      ...
      [],
  groundednessScores:
      (json['groundedness_scores'] as List<dynamic>?)
          ?.map((e) => GroundednessScoreDto.fromJson(e as Map<String, dynamic>))
          .toList() ??
      [],
...
Map<String, dynamic> _$QueryResponseDtoToJson(QueryResponseDto instance) =>
    <String, dynamic>{
      'conversation_id': instance.conversationId,
      'retrieval_contents': instance.retrievalContents
          .map((e) => e.toJson())
          .toList(),
      'attributions': instance.attributions?.map((e) => e.toJson()).toList(),
      'groundedness_scores': instance.groundednessScores
          ?.map((e) => e.toJson())
          .toList(),
...
RerankRequest _$RerankRequestFromJson(
  Map<String, dynamic> json,
) => RerankRequest(
...
_$RetrievalContentCustomMetadataConfigDtoFromJson(Map<String, dynamic> json) =>
    RetrievalContentCustomMetadataConfigDto(
      filterable: json['filterable'] as bool?,
      inChunks: json['in_chunks'] as bool?,
      returnedInResponse: json['returned_in_response'] as bool?,
...
RetrievalInfoResponseDto _$RetrievalInfoResponseDtoFromJson(
  ...
  contentMetadatas:
      (json['content_metadatas'] as List<dynamic>?)
          ?.map((e) => e as Object)
          .toList() ??
      [],
);
...
) => <String, dynamic>{'content_metadatas': instance.contentMetadatas};
...
TopUpHistoryResponseDto _$TopUpHistoryResponseDtoFromJson(
  Map<String, dynamic> json,
) => TopUpHistoryResponseDto(history: json['history']);
...
_$SrcContextualRagModelsComponentsParseDtoDocumentMetadataDtoToJson(
  SrcContextualRagModelsComponentsParseDtoDocumentMetadataDto instance,
) => <String, dynamic>{'hierarchy': instance.hierarchy?.toJson()};
...
_$SrcContextualRagModelsDatastoresDatastoreDocumentDtoEmptyResponseDtoToJson(
  SrcContextualRagModelsDatastoresDatastoreDocumentDtoEmptyResponseDto instance,
) => <String, dynamic>{};
...
_$SrcContextualRagModelsDatastoresDatastoreDtoEmptyResponseDtoToJson(
  SrcContextualRagModelsDatastoresDatastoreDtoEmptyResponseDto instance,
) => <String, dynamic>{};
...
_$SrcCoreSharedConstantsDtoDataResponseEmptyResponseDto1FromJson(
  ...
  status:
      SrcCoreSharedConstantsDtoDataResponseEmptyResponseDto1.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
...
_$SrcCoreSharedConstantsDtoDataResponseEmptyResponseDto2FromJson(
  ...
  status:
      SrcCoreSharedConstantsDtoDataResponseEmptyResponseDto2.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
      ? null
      : SrcContextualRagModelsDatastoresDatastoreDtoEmptyResponseDto.fromJson(
          json['data'] as Map<String, dynamic>,
        ),
  error: json['error'] as String?,
);
...
_$SrcCoreSharedConstantsDtoDataResponseEmptyResponseDto3FromJson(
  ...
  status:
      SrcCoreSharedConstantsDtoDataResponseEmptyResponseDto3.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
      ? null
      : SrcContextualRagModelsDatastoresDatastoreDocumentDtoEmptyResponseDto.fromJson(
          json['data'] as Map<String, dynamic>,
        ),
  error: json['error'] as String?,
);
...
_$SrcCoreSharedConstantsDtoDataResponseEmptyResponseDto4FromJson(
  ...
  status:
      SrcCoreSharedConstantsDtoDataResponseEmptyResponseDto4.responseStatusStatusNullableFromJson(
        json['status'],
      ),
  message: json['message'] as String?,
  data: json['data'] == null
      ? null
      : SrcContextualRagModelsComponentsBillingDtoEmptyResponseDto.fromJson(
          json['data'] as Map<String, dynamic>,
        ),
  error: json['error'] as String?,
);
...
_$SrcCoreSharedConstantsDtoEmptyResponseDtoFromJson(
  ...
  status:
      SrcCoreSharedConstantsDtoEmptyResponseDto.responseStatusStatusNullableFromJson(
        json['status'],
      ),
);
...
) => <String, dynamic>{'status': responseStatusNullableToJson(instance.status)};
